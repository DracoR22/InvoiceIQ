...
import { ObjectViewer } from "../viewers/object-viewer";
...
const VerificationPipeline = ({
  ...
  const [analysisResult, setAnalysisResult] = useState<{ corrections: any[]; textAnalysis: string } | null>(null);
      ...
      <div className="flex flex-1 justify-center">
        {isProcessed ? (
          <div className="w-full h-full flex flex-col justify-center items-center">
            <Icons.checkCircle2 strokeWidth={1.4} className="text-green-500 w-32 h-32 my-6" />
