...
import { UploadInfo } from "../pipelines/upload-pipeline";
import { useStepStore } from "@/lib/store";
import { cn, formatBytes } from "@/lib/utils";
import { Label } from "../ui/label";
import { Icons } from "../icons";
import { Switch } from "../ui/switch";
import { HelpTooltip } from "../ui/help-tootlip";
...
type SettledResult = {
  ...
  export function Dropzone({ className, updateUploadInfos }: { className?: string; updateUploadInfos: (uploadInfos: UploadInfo) => void }) {
    ...
    return (
      <div className={cn(className, "flex flex-col items-center justify-center")}>
        <div className="flex items-center gap-2">
          <Switch id="bulk-processing" disabled onCheckedChange={() => setBulkProcessing((previousState) => !previousState) } checked={isBulkProcessing}/>
